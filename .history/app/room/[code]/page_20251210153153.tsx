...
export default function RoomPage() {
  ...
  const { roomState, isConnected, joinRoom, makeMove, sendChat, leaveRoom, setRoomState } = useSocket(user?.id)
        ...
        setRoomState((prev) => {
          ...
          return {
            ...
            gameState: {
              ...
              rummy: newRummyState,
              winner:
                newRummyState.winner === "player" ? user?.id : newRummyState.winner === "opponent" ? "player1" : null,
  ...
  }, [roomState?.gameState?.rummy, user?.id, setRoomState])
