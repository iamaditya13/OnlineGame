...
import { SidebarFriends } from "@/components/layout/sidebar-friends"
...
export default function LobbyPage() {
  ...
  const { createRoom } = useSocket(user?.id)
  ...
  const handleCreateRoom = (gameType: string, mode: string) => {
    const roomCode = createRoom(gameType, mode)
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <UsernameModal open={!user} onSubmit={createUser} />
