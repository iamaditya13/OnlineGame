...
const TUTORIALS: Record<string, { title: string; instructions: string[] }> = {
  ...
  "secret-code": {
    title: "How to Play Secret Code (Colors)",
    instructions: [
  ...
  "secret-code-numbers": {
    title: "How to Play Secret Number",
    instructions: [
      "The computer generates a secret code of 4 numbers (0-9).",
      "You have 10 attempts to guess the code.",
      "After each guess, you get feedback:",
      "Black Peg: Correct number in the correct position.",
      "White Peg: Correct number but in the wrong position."
    ]
  },
  "secret-code-letters": {
    title: "How to Play Secret Letters",
    instructions: [
      "The computer generates a secret code of 4 letters (A-F).",
      "You have 10 attempts to guess the code.",
      "After each guess, you get feedback:",
      "Black Peg: Correct letter in the correct position.",
      "White Peg: Correct letter but in the wrong position."
    ]
  },
  "go-fish": {
