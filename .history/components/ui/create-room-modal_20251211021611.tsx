...
const GAMES = [
  ...
  { id: "secret-code", name: "Secret Code (Colors)" },
  { id: "secret-code-numbers", name: "Secret Number" },
  { id: "secret-code-letters", name: "Secret Letters" },
...
export function CreateRoomModal({ open, onOpenChange, onCreateRoom, selectedGame }: CreateRoomModalProps) {
  ...
  const handleCreate = () => {
    onCreateRoom(gameType, mode, isAiGame, difficulty)
    onOpenChange(false)
  }
